module Af
  ...
  class CommandLiner
    ...
    class << self
      ...
      def command_line_option_groups_store
      ...
      def opt_assign_group(opt_name, group_name)
        command_line_option_groups_store[group_name] ||= {}
      ...
      def evaluate_argument_for_type(argument, type_name, option_name, command_line_option)
